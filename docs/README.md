...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-24 21:04:57 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读3篇，重点聚焦三维重建与深度估计。最值得关注的是精读论文《M2Depth》，将单目深度先验与多视图立体融合，得分8.0/10。建议普通读者优先了解该方向，其余三篇可作为相关技术拓展。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="M2Depth: Unifying Monocular Depth Foundation Priors with Multi-View Stereo">M2Depth: Unifying Monocular Depth Foundation Priors with Multi-View Stereo</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Core-KAN: Continuous Vision Kernels with Kolmogorov-Arnold Networks">Core-KAN: Continuous Vision Kernels with Kolmogorov-Arnold Networks</span></li><li><span class="dpr-home-dashboard-paper-title" title="Unified and Efficient Point-Line Local Features">Unified and Efficient Point-Line Local Features</span></li><li><span class="dpr-home-dashboard-paper-title" title="Sparse Light Field Sampling Improves Casual 3D and 4D Reconstruction">Sparse Light Field Sampling Improves Casual 3D and 4D Reconstruction</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">stereo-depth <strong>2</strong></span><span class="dpr-home-dashboard-tag">cv-render <strong>1</strong></span></div>
</section>
</div>
