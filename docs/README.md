...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-08-23 20:48:24 UTC<br>状态：成功</p>
</section>
...
<p>速读：《CrevasseSeg: A Label-Efficient UAV Crevasse Segmentation Framework》（7.0/10）, 《Point Spread Function Engineering Using Implicit Neural Representations》（7.0/10）, 《Interactive Whole Slide Images for RL-based Tumour Segmentation》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="CrevasseSeg: A Label-Efficient UAV Crevasse Segmentation Framework">CrevasseSeg: A Label-Efficient UAV Crevasse Segmentation Framework</span></li><li><span class="dpr-home-dashboard-paper-title" title="Point Spread Function Engineering Using Implicit Neural Representations">Point Spread Function Engineering Using Implicit Neural Representations</span></li><li><span class="dpr-home-dashboard-paper-title" title="Interactive Whole Slide Images for RL-based Tumour Segmentation">Interactive Whole Slide Images for RL-based Tumour Segmentation</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">seg <strong>3</strong></span><span class="dpr-home-dashboard-tag">cv-render <strong>2</strong></span><span class="dpr-home-dashboard-tag">stereo-depth <strong>1</strong></span></div>
</section>
</div>
